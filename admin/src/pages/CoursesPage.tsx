...
export default function CoursesPage() {
  ...
  const [selectedEducationalLevel, setSelectedEducationalLevel] = useState<string>('');
  ...
  useEffect(() => {
    filterCourses();
  }, [courses, subscriptions, location.pathname, searchTerm, selectedMonth, selectedEducationalLevel]);
  ...
  const filterCourses = () => {
    ...
    if (selectedEducationalLevel) {
      filtered = filtered.filter(c => c.educationalLevel._id === selectedEducationalLevel);
    }
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <Select value={selectedEducationalLevel || undefined} onValueChange={setSelectedEducationalLevel}>
              <SelectTrigger className="w-full md:w-48">
                <SelectValue placeholder="المستوي الدراسي" />
              </SelectTrigger>
              <SelectContent>
            ...
            {(searchTerm || selectedMonth || selectedEducationalLevel) && (
              <Button
                variant="outline"
                onClick={() => {
                  setSearchTerm('');
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-muted-foreground mb-2">{selectedCourse.educationalLevel.nameAr}</p>
